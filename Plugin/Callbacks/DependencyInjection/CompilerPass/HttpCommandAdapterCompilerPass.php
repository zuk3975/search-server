...
/**
 * Class HttpCommandAdapterCompilerPass.
 */
class HttpCommandAdapterCompilerPass extends TagCompilerPass
{
    /**
    ...
    {
        return 'apisearch_plugin.callbacks.http_command_adapters';
    }
    ...
    {
        return 'apisearch_plugin_endpoints_http_command_adapter';
    }
}
