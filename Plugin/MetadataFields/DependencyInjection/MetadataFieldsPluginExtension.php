...
namespace Apisearch\Plugin\MetadataFields\DependencyInjection;

use Mmoreram\BaseBundle\DependencyInjection\BaseExtension;
use Symfony\Component\Config\Definition\ConfigurationInterface;

/**
 * Class MetadataFieldsPluginExtension.
 */
class MetadataFieldsPluginExtension extends BaseExtension
{
    /**
    ...
    {
        return 'apisearch_plugin_metadata_fields';
    }
    ...
    {
        return [
            'apisearch_plugin.metadata_fields.repository_service' => $config['repository_service'],
        ];
    }
    ...
    {
        return new MetadataFieldsPluginConfiguration($this->getAlias());
    }
}
