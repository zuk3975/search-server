...
use Apisearch\Plugin\MetadataFields\Redis\Repository\RedisMetadataRepository;
use Apisearch\Query\Query;

/**
 * Class RedisTest.
 */
class RedisTest extends MetadataFieldsFunctionalTest
{
    /**
     * Basic usage.
     */
    public function testBasicUsage()
    {
        ...
        $this->assertCount(3, $redisClient->hgetall(RedisMetadataRepository::PLUGIN_KEY));
    }
    ...
    {
        $configuration['apisearch_plugin_metadata_fields']['repository_service'] = 'apisearch_plugin.metadata_fields.redis_repository';
